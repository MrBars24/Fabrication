<nav class="sidebar-nav">
    <ul id="sidebarnav">
        <li>
            <a href="<?= base_url('about'); ?>" aria-expanded="false"><span class="hide-menu">About</span></a>
        </li>
        <li>
        ...
        <li>
            <a href="<?= base_url('jobs'); ?>">Job Bank </a>
        ...
        <li>
            <a class="waves-effect waves-dark" href="/pricing" aria-expanded="false"><span class="hide-menu">Pricing</span></a>
            <!-- <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('/watch-list') ?>" aria-expanded="false">
                ...
                <i class="mdi mdi-chevron-down hidden-xs"></i>
            </a> -->
        </li>
    </ul>
</nav>
