...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index-2.html">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="/assets/images/small-logo.png" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="/admin" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">DASHBOARD </span></a></li>
                        <li> <a class="waves-effect waves-dark" href="/admin/jobs" aria-expanded="false"><i class="mdi mdi-library"></i><span class="hide-menu">JOBS </span></a></li>
                        <li> <a class="waves-effect waves-dark" href="/admin/jobs-category" aria-expanded="false"><i class="mdi mdi-format-list-bulleted"></i>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-bullseye"></i><span class="hide-menu">Content Menu</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="/admin/image/assets">Image Assets</a></li>
                            </ul>
                        </li>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer"> © 2017 E-FAB </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
        </div>
