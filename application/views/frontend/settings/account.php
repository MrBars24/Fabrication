            ...
            <div class="card">
                <div class="row">
                    ...
                    <div class=" col-lg-9 bg-light-part">
                                        ...
                                        <li class="list-group-item">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-8 ">
													...
													<?php
														$xclude = array('google','facebook');
														if(!in_array(auth()->login_type,$xclude)):
													?>
                                                    <input type="text" class="form-control form-control-settings-account d-none" name="username" value="<?= $_SESSION['user']->username ?>">
													<?php else: ?>
													<h5 class="text-dark form-control-settings-account d-none" data-value-target="username"><?= $_SESSION['user']->username ?></h5>
													<?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-8">
													...
													<?php else: ?>
													<h5 class="text-dark form-control-settings-account d-none" data-value-target="email"><?= $_SESSION['user']->email ?></h5>
													<?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                        ...
                                        <li class="list-group-item">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-8">
                                                    ...
                                                    ?>
                                                    <h5 class="text-dark form-control-settings-location-hide" data-value-target="country_id"><?php echo $user_details->country_name ?></h5>
                        ...
                        <!--<div class="card">
                            <div class="p-4">
                                <h3 class="card-title font-weight-bold mb-0 float-left">Billing Information</h3>
                                <span class="d-flex float-right">
                                    <div class="form-control-settings-account d-none ">
                                        <button type="submit" class="btn btn-success " name="submit">Save Changes</button>
                                    </div>
                                    <button type="button" class="btn btn-success ml-2" data-toggle="edit-settings-input" data-target=".form-control-settings-billing">Edit</button>
                                </span>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
