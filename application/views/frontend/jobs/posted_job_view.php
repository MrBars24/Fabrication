                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            ...
                            <?php if($job->status == "open"): ?>
                                <a href="javascript:void(0)" id = "btn-close-bidding" data-job-id="<?= $job->id ?>" class="btn btn-sm btn-danger btn-block text-white m-r-10" data-toggle="tooltip" title="Manage Job"><i class="mdi mdi-close-network"></i> Close Bidding</a>
                            <?php elseif($job->status == "awarded"): ?>
                                <a href="javascript:void(0)" id = "btn-finished-bidding" data-job-id="<?= $job->id ?>" class="btn btn-sm btn-danger btn-block text-white m-r-10" data-toggle="tooltip" title="Manage Job"><i class="mdi mdi-close-network"></i> Mark As Finish</a>
                            <?php endif; ?>
                                ...
                                <a href="/jobs/update/<?= $job->id ?>" class="btn btn-sm btn-info btn-block text-white m-r-10" title="Edit Information" ><i class="mdi mdi-tooltip-edit"></i>  Edit Information</a>
                            </div>
                        </div>
                        <div class="col-sm-10">
                            <h2 class="mt-2 mb-0"><strong><?= $job->title ?></strong></h2>
                            ...
                            <div class="row">
                                <div class="col">
                                    <ul class="p-0 list-style-type-none">
                                        ...
                                        <li class="">Expertise:
                                            ...
                                            <?php if(count($job->expertise) > 0): ?>
                                                <?php $expertises = array(); ?>
                                                <?php foreach($job->expertise as $expertise): ?>
                                                    <?php $expertises[] = $expertise->title ?>
                                                <?php endforeach; ?>
                                                <?= implode(', ',$expertises); ?>
                                            <?php else: ?>
                                                <?= "Any" ?>
                                ...
                                <div class="col">
                                    <ul class="p-0 list-style-type-none">
                                        <li class="">Status: <span id = "job-status" class="font-weight-bold text-success"><?php echo $job->status ?></span></li>
                                        ...
                                        <li class="">Material:
                                            <span class="font-weight-bold">
                                            <?php if(count($job->materials) > 0): ?>
                                                <?php $materials = array(); ?>
                                                <?php foreach($job->materials as $material): ?>
                                                    <?php $materials[] = $material->material_name ?>
                                                <?php endforeach; ?>
                                                <?= implode(', ', $materials) ?>
                                            <?php else: ?>
                                                <?= "Any"; ?>
                            ...
                            <div class="earning-widget">
                                ...
                                <div class="card-body b-t">
                                    <table class="table v-middle no-border">
                                        <tbody>
                                            <!-- Post Job List Item -->
                                            <?php $this->load->view('frontend/partials/view_bids') ?>
...
<!-- Message modal -->
<div class="modal fade modal-message-bidder" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="myLargeModalLabel">Message <span class="text-primary">Microsoft edge</span></h3>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1">
                            <button class="btn-send-message btn btn-info mt-3" id="send-btn"><i class="mdi mdi-send"></i></button>
                    </div>
                </div>
...
<!-- Edit Job modal -->
<!-- <div class="modal fade modal-job-edit" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="desc" rows="4"><?= $job->description ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="min_budget" class="form-control" required="" data-validation-required-message="This field is required" value="<?= $job->budget_min ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="max_budget" class="form-control" required="" data-validation-required-message="This field is required" value="<?= $job->budget_max ?>">
                            </div>
                        </div>
                    </div>
                </div>
