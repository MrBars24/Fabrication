                ...
                <div class="card-header">
                    ...
                    <div class="d-flex flex-row justify-content-between mt-4">
                        ...
                        <div>
                            ...
                            <span class="d-block icon-2x text-primary">Finish</span>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <ul class="p-0 list-style-type-none">
                                <li class="">Bidding Start: <span class="font-weight-bold">Mar 2018</span></li>
                                <li class="">Expire <span class="font-weight-bold">Dec 2019</span></li>
                            </ul>
                        </div>
                        <div class="col">
                            <ul class="p-0 list-style-type-none">
