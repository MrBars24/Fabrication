                ...
                <div class="row ">
                    <div class="col-sm-12">
                        <div class="text-left mt-3">
                           <h3 class="text-white">SUBMIT A PROPOSAL</h3> 
                        </div>
                    </div>
                </div>
...
<?= form_open('jobs/bid-history', array('id'=>'form-proposal', 'method' => 'POST')) ?>
    <section>
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="card mt-4">
                        <div class="card-header">
                            <h1 class="mt-2 mb-0"><strong>Build 10storey Building in Manhattan</strong></h1>
                        </div>
                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="mb2">
                                                        ...
                                                        <h6 class="text-dark font-weight-bold">$5,000 – $10,000</h6>
                                                    </div>
                                                    <div class="mb2">
                                                        <small class="text-secondary mb-0">APPROX. TONNES</small>
                                                        <h6 class="text-dark font-weight-bold">30t</h6>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb2">
                ...
                <div class="col-sm-12">
                    <div class="card ">
                         <div class="row">
                             <div class="col-sm-12">
                                 <div class="card-header">
                                     <h3 class="card-title mt-3">Terms</h3>
                                 </div>
                                 <div class="card-body">
                                     <h5 class="card-title">What is your proposed Amount to bid for this project?</h5>

                                     <div class="row">
                                         <div class="col-sm-8">
                                             <h3 class="card-title">Budget: <big class="text-green">$ 150,000</big></h3>
                                             ...
                                             <div class="input-group col-7">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0.00" value="25000" aria-label="Text input with radio button">
                                                </div>
                                         </div>
                                         <div class="col-sm-4">
                                            <img src="/assets/images/log_icon_gray.png" style="max-width: 140px;" alt="e-fab">
                ...
                <div class="col-sm-12">
                    <div class="card ">
                         <div class="row">
                             <div class="col-sm-12">
                                 <div class="card-header">
                                     <h3 class="card-title mt-3">Additional Information</h3>
                                 </div>
                                 <div class="card-body">
                                     <h5 class="card-title">Cover Letter</h5>

                                     <textarea class="textarea_editor form-control" style="height:250px;"></textarea>
                                     
                                     <h5 class="card-title">Attatchment</h5>
                                     
                                     
                                     
                                     <label id="ap" for="upload-attachment">
                                         <div class="proposal-attatchment">
                                             <span>Click here to upload an attachment</span>
                                             <input type="file" id="upload-attachment" style="visibility: hidden;" multiple />
                                         </div>
                                     </label>
                                        
                                 </div>
                                 <div class="card-footer">
                                    <button type="submit" class="btn btn-default custom-btn-color"> Submit proposal </button>
<!--                                     <a href="<?= base_url('jobs/bid-history') ?>"  class="btn btn-default custom-btn-color">Submit proposal</a>-->
                                 </div>
                             </div>
                        </div>
                    </div>
