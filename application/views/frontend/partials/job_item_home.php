<div class="row">
    <div class="col-sm-6">
        ...
        <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates eos voluptatum et dolore ex expedita?</p>
        <a href="<?php echo base_url('jobs/1') ?>" class="btn btn-warning text-dark mt-2 py-0"><span class="align-middle">Job Details and Requirements</span><i class="fa fa-angle-right fa-2x align-middle ml-2"></i></a>
    </div>
    <div class="col-sm-6">
        <div class="row">
            <div class="col">
