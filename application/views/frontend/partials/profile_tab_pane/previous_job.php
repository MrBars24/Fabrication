<div class="tab-pane " id="previous" role="tabpanel">
    <div class="card-body p-0">
        <ul class="list-group list-group-flush">
            <?php if($previousJobs['data']): ?>
                <?php foreach($previousJobs['data'] as $job):?>
                    <li class="list-group-item">
                        <h4 class="font-weight-bold mb-0"><a href="<?php echo base_url("jobs/$job->id") ?>"><?= $job->title ?></a></h4>
                        <small class="text-muted"><?= date_new_format($job->finished_at) ?></small>
            ...
            <?php else: ?>
                <li class="list-group-item">
                    <h4 class="font-weight-bold text-center mb-0">No Previous Job</h4>
                </li>
            <?php endif; ?>
        </ul>
    </div>
