            ...
            render: function(data) {
                ...
                if(data.length > 0){
                    data.forEach(function(obj, index) { 
                        var img = print_image(obj.user_details.avatar_thumbnail);
                        ...
                        container += `
                            <div class="">
                                ...
                                <div class="sl-item">
                                    <div class="sl-left"> <img src="${img}" alt="user" class="img-circle"> </div>
                                    <div class="sl-right">
    ...
    $(document).on("submit", "#form-send-discussion", function(e){
        ...
        $.ajax({
            ...
            success: function(result){
                if(result.success){
                    var img = print_image(result.data.user_details.user_details.avatar);
